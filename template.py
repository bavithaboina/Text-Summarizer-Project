...
for file_path in list_of_files:
    ...
    # if a file with same name exists and there is data in the file ,I should not modify the file bcs i will lose my content in the file as I am opening the file in "write " mdoe
